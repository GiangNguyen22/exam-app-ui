    ...
    fun createBytes(
        ...
        val rows = listOf(
            ...
            listOf(
                ...
                "A network protocol",
                "A",
                "Activity represents one app screen."
            ),
            listOf(
                "2",
                "Android",
        ...
        val listRows = buildListRows(subjectNames, topicNames, typeOptions, difficultyOptions)
...
<workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  <sheets>
    <sheet name="Exam Questions" sheetId="1" r:id="rId1"/>
